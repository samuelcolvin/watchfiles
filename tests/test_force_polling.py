...
def test_watch_polling_not_env(mocker):
    ...
    m.assert_called_once_with(['.'], False, False, 300, True, False, True)
...
def test_watch_polling_env(mocker, env: SetEnv):
    ...
    m.assert_called_once_with(['.'], False, True, 300, True, False, True)
...
def test_watch_polling_env_with_custom_delay(mocker, env: SetEnv):
    ...
    m.assert_called_once_with(['.'], False, True, 1000, True, False, True)
